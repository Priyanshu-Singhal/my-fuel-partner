                ...
                if (valid) {
                    fAuth.signInWithEmailAndPassword(email.getEditText().getText().toString() , password.getEditText().getText().toString()).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            Toast.makeText(CustomerSignin.this, "SignIn Successfully" , Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(CustomerSignin.this ,"Please enter a valid Email & Password..." , Toast.LENGTH_SHORT ).show();
                        }
                    });
                }
            }
